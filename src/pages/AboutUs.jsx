  ...
  <section className="relative h-screen flex items-center overflow-hidden">
    ...
    <div className="relative z-10 w-full px-8 md:px-16 lg:px-24">
      ...
      >
        ...
        <p className="text-lg md:text-xl text-white/90 font-light leading-relaxed max-w-xl mt-6">
...
const PhilosophySection = () => (
  ...
  >
    <div className="text-center max-w-3xl mx-auto mb-16">
      <motion.h2 variants={itemVariants} className="text-4xl md:text-5xl font-serif font-light mb-4">Our Philosophy</motion.h2>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
      <motion.div variants={itemVariants}>
        ...
        <p className="text-gray-600">From the grandest gestures to the smallest details, we pursue perfection in everything we do.</p>
      </motion.div>
      <motion.div variants={itemVariants}>
        <FiHeart className="mx-auto text-4xl text-yellow-600 mb-4" />
        <h3 className="text-2xl font-semibold mb-2">Passion</h3>
        <p className="text-gray-600">Our work is our passion. We pour our hearts into creating unforgettable experiences.</p>
      </motion.div>
      <motion.div variants={itemVariants}>
        <FiUsers className="mx-auto text-4xl text-yellow-600 mb-4" />
        <h3 className="text-2xl font-semibold mb-2">Partnership</h3>
        <p className="text-gray-600">We work alongside you as trusted partners, ensuring your vision is at the core of our creation.</p>
      </motion.div>
    </div>
  </motion.section>
);
...
const TeamSection = () => (
    ...
    >
        <div className="text-center max-w-3xl mx-auto mb-16">
            <motion.h2 variants={itemVariants} className="text-4xl md:text-5xl font-serif font-light mb-4">Meet the Artisans</motion.h2>
            <motion.p variants={itemVariants} className="text-lg text-gray-600">
            ...
            {[
                ...
                <motion.div key={index} variants={itemVariants} className="text-center group">
                    <div className="relative overflow-hidden rounded-lg mb-4">
                        <img src={member.img} alt={member.name} className="w-full h-80 object-cover transform group-hover:scale-105 transition-transform duration-500 ease-out" />
                    </div>
...
const CraftsmanshipSection = () => (
    <motion.section 
        className="py-24 px-8 md:px-16 lg:px-24 flex flex-col lg:flex-row items-center gap-16"
        variants={sectionVariants}
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, amount: 0.3 }}
    >
        <motion.div variants={itemVariants} className="lg:w-1/2">
            <img src="/swaranjali11.png" alt="Crafting an event" className="rounded-lg shadow-xl w-full" />
        </motion.div>
        <motion.div variants={itemVariants} className="lg:w-1/2">
            <h2 className="text-4xl md:text-5xl font-serif font-light mb-6">Our Craftsmanship</h2>
...
const CtaSection = () => (
  <motion.section 
    className="bg-gray-800 text-white py-24 px-8 md:px-16 lg:px-24 text-center"
    initial={{ opacity: 0 }}
    whileInView={{ opacity: 1 }}
    viewport={{ once: true, amount: 0.5 }}
    transition={{ duration: 1.0 }}
  >
    <h2 className="text-4xl md:text-5xl font-serif font-light mb-6">Let's Create Together</h2>
    <p className="text-lg text-gray-300 max-w-2xl mx-auto mb-8">
      Have a vision for your next event? We'd love to hear it. Reach out to us to begin your journey with Swaranjali.
    </p>
    <motion.button 
      className="bg-[#6D2C2C] text-white font-semibold py-3 px-8 rounded-full inline-flex items-center gap-2 transition-colors duration-300 hover:bg-yellow-700"
